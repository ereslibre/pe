...
public class CromosomaF3 extends agsimple.Cromosoma {
	...
	@Override
	public Object clone() {
		CromosomaF3 res = new CromosomaF3();
		res.m_madre = m_madre;
		res.m_padre = m_padre;
	...
	public Cruce cruzar(ag.Cromosoma cromosoma) {
		...
		Cromosoma hijo1 = Factoria.generaCromosoma(m_poblacion, Factoria.Funcion3);
		...
		Cromosoma hijo2 = Factoria.generaCromosoma(m_poblacion, Factoria.Funcion3);
